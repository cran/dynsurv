...
namespace ir {
	...
	{	
		...
		for (Size i = 0; i < n; ++i) {
		    ...
		    //std::cout << "Individual observed likelihood: " 
		 	//	<< ublas::row(obsLikeMat, i) << std::endl;	
			//std::cout << "Sum of individual observed likelihood: " 
			//	<< ublas::sum(ublas::row(obsLikeMat, i)) << std::endl;	
		}
		...
		// Debug
		//std::cout << "Individual log(CPO): " << ublas::log(CPO) << std::endl;
		//for (Size i = 0; i < N_; ++i) 
		//	std::cout <<"Subject "<< i << "-------------------------- " << "\n"
		//		<< "  Observed likelihood: " <<ublas::column(obsLikeMat, i) << "\n" 
		//		<< "  Inverse observed likelihood: " << ublas::column(invObsLikeMat, i) << "\n"
		//		<< ublas::sum(ublas::column(invObsLikeMat, i)) / N_ << " " 
		//		<< CPO(i) << " " << std::log(CPO(i)) << std::endl;
